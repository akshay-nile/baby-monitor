...
function ToggleSwitch({ checked, onChange, id }: Props) {
    ...
    return (
        <div className="w-19 h-10 flex items-center border border-pink-500 rounded-full cursor-pointer scale-80"
            ...
            <div className={`w-8 h-8 rounded-full transition-all ease-in-out duration-200 relative
                            ${isChecked ? 'bg-pink-500 translate-x-10' : 'bg-neutral-500 translate-x-1'}`} />
