...
function UserSettings() {
    ...
    return (
        <PageAnimation>
            <div className="w-full md:w-1/2 lg:w-1/3 mx-auto min-h-dvh flex flex-col justify-between items-center gap-5 p-4 text-white bg-neutral-800 rounded-xl select-none duration-300 transition-all">
                ...
                <div className="w-full flex flex-col gap-5 my-auto">
                    <Panel header="Baby Device Settings" className="w-full">
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex justify-between items-center">
                                <label htmlFor="useMotionDetection">Use Motion Detection Feature</label>
                                <ToggleSwitch id="useMotionDetection"
                            ...
                            </div>
                            {
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <Dropdown id="motionSensitivity" className="mr-1" pt={{ input: { style: { padding: '0.4rem 0.8rem', border: '1px solid pink' } }, trigger: { style: { display: 'none' } } }}
                                        options={[{ name: 'Low', value: 100 }, { name: 'Medium', value: 50 }, { name: 'High', value: 10 }]} optionLabel="name" optionValue="value"
